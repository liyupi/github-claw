...
```bash
# Copy the skills/github-claw/ directory into your target repository
cp -r skills/github-claw/ /path/to/your-repo/skills/github-claw/
...
cp -r /tmp/github-claw/skills/github-claw/ /path/to/your-repo/skills/github-claw/
...
└── skills/
    └── github-claw/                   # This skill (keep for reference)
```
